...
from scapy.consts import LINUX, FREEBSD, NETBSD, OPENBSD, BIG_ENDIAN
...
class TunTapInterface(SimpleSocket):
    ...
    * https://www.kernel.org/doc/Documentation/networking/tuntap.txt
    ...
    def __init__(self, iface=None, mode_tun=None, default_read_size=MTU,
        ...
        elif FREEBSD or NETBSD or OPENBSD:
        ...
        self.closed = False
        super(TunTapInterface, self).__init__(sock, default_read_size)
...
conf.L2listen, conf.L2socket or conf.L3socket.
    ...
    def recv_raw(self, x=None):
        ...
        x += self.mtu_overhead
        return self.kernel_packet_class, self.ins.recv(x), time.time()
